...
video_path = 'C:\\Users\\zjkee\\OneDrive\\바탕 화면\\rpy\\video_cut\\4_front_2\\part5\\'
save_path = "C:\\Users\\zjkee\\OneDrive\\바탕 화면\\rpy\\video_cut\\4_front_2\\part5\\"
        ...
        with mp_holistic.Holistic(
            ...
            while cap.isOpened():
                ...
                if not success:
                    ...
                    pose_df.to_excel(save_path+file_name+"_pose_world.xlsx")
                    pose_data = []
